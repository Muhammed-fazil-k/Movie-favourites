...
import { FavMoviesContext, FavMoviesDispatchContext } from "./favourite/FavouriteContext";
              ...
              <div className={styles["movie-item-rating-favorite"]}>
                ...
                >
                  <a onClick={handleFavourite}>
                    {isFavourite? <FaHeart style={{ color: "red",transform: 'scale(1.2)' }} /> : <FaRegHeart style={{ color: 'red' }} />}
